...
-- Tiempo de generación: 04-11-2016 a las 19:44:46
...
CREATE TABLE `comentario` (
  ...
  `id_usuario_comentando` int(11) NOT NULL,
...
INSERT INTO `comentario` (`id`, `id_usuario_comentado`, `id_usuario_comentando`, `descripcion`, `fecha`) VALUES
(1, 1, 2, 'Muy bueno y confiable... 100% recomendado.', '2016-10-24 15:25:21'),
(2, 2, 1, 'Esta es una reseña de prueba', '2016-10-24 21:50:59'),
(3, 2, 1, 'Reseña de prueba 2', '2016-10-24 21:51:34'),
(4, 2, 1, 'Esto es una prueba para el avance', '2016-10-24 22:32:46'),
(5, 2, 1, 'asdasdsadsdasdas', '2016-10-28 13:27:32');
...
CREATE TABLE `producto` (
  ...
  `tipo_publicacion` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `usuario` (`id`, `nombre`, `email`, `password`, `avatar`, `fecha_creacion`, `fecha_actualizacion`) VALUES
(1, 'Felipe Schneeberger', 'itsshompi@gmail.com', 'ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f', 'avatar.jpg', '2016-10-17 10:33:15', '2016-10-31 16:18:56'),
...
CREATE TABLE `valoracion` (
  `id` int(11) NOT NULL,
  `id_usuario_valorado` int(11) NOT NULL,
  `id_usuario_valorando` int(11) NOT NULL,
  `nota` int(2) NOT NULL
...
INSERT INTO `valoracion` (`id`, `id_usuario_valorado`, `id_usuario_valorando`, `nota`) VALUES
(1, 1, 1, 7),
(2, 2, 1, 6);
